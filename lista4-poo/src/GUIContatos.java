...
public class GUIContatos extends JPanel{
	...
	public void inicializarComponentes() {
		...
		lbDdd.setBounds (5, 15, 45, 25);
		lbNumero.setBounds (5, 45, 45, 25);
		lbNome.setBounds (5, 75, 45, 25);
		tfDdd.setBounds (55, 15, 45, 25);
		tfNumero.setBounds (55, 45, 100, 25);
		tfNome.setBounds (55, 75, 280, 25);
	...
	public void definirEventos() {
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				tfNumero.setText((String)table.getValueAt(table.getSelectedRow(), 0));
				tfNome.setText((String)table.getValueAt(table.getSelectedRow(), 1));
				tfDdd.setText((String)table.getValueAt(table.getSelectedRow(), 2));
		...
		btExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					p.setNumero(Integer.parseInt(tfNumero.getText()));
				}
	...
	public static void main (String[] args) {
		...
		ImageIcon icon1 = new ImageIcon("iconAgenda.png");
		frame.setIconImage(icon1.getImage());
		
		frame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().add (new GUIContatos());
		frame.pack();
